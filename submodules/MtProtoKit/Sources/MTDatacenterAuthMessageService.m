    ...
    dispatch_once(&onceToken, ^{
        testingPublicKeys = @[
            [[MTDatacenterAuthPublicKey alloc] initWithPublicKey:@"-----BEGIN RSA PUBLIC KEY-----\n"
             "MIIBCgKCAQEA02IpIBOzxuRMKgZWDYBiGZ5vPIA0KO7rhYWH77lHkzpsQMTUuSR4\n"
             "S/TD797QSGOi/ZnIyXRmtGQODWCR2jZsjZzKzJq3lwlsKpFoyXDe90RPj2CoR1aV\n"
             "fnmVGMy3PqGPspZWnek9ywoaWYHT/eoSInmBdrJv2miHYZ2B/Vjq3KQDmPuF5oIJ\n"
             "fzKtX9QzJzaB3fndrC+QnF6gvnDf6/dtFaZSL3xmrOUiEITX4Bq+ecd19hsKmWUz\n"
             "7OUDQi76XqVGDBPqtiKCRbZoRAH3tNhVKy3YACIBOMMgLRgQB1qGWZYtCcyD9k08\n"
             "dfo0K1LEfNVwNbbwc8rsp0a7HMR8aYLSrQIDAQAB\n"
             "-----END RSA PUBLIC KEY-----"]
        ];
